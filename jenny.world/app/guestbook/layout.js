...
import guestbookStyles from "../styles/guestbook.module.css";
import Footer from "../components/Footer"

const inter = Inter({ subsets: ["latin"] });

export const metadata = {
  title: "Guestbook | The World of Jenny Liu Zhang",
  description: ":)",
};
      ...
      <header className="header">
          ...
          <div className="pageNav">
              ...
              <div className="rightNav">
                ...
                <Link className={guestbookStyles.guestbookActive} href="/guestbook">Guestbook</Link>
              </div>
          </div>
      </header>
