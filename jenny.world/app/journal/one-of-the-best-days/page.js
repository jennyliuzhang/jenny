  ...
  return (
    <main className={entryStyles.entryStyles}>
      <div className={entryStyles.writingTop}>
        <h2><span className="subnav"><Link href="/journal" className="breadcrumb">Jenny&rsquo;s Journal</Link>One of the Best Days of My Year</span></h2>
      </div>
      ...
      <div className={entryStyles.body}>
        <h1>One of the Best Days of My Year</h1>
        <h6>June 2022</h6>
        <h6>3 min read</h6>
