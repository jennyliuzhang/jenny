...
export default function JournalEntryPage() {
  ...
  const heroCaption = "The train tracks we would always walk through during our daily walks. Sometimes fennel grew between the tracks.";

  return (
    <EntryLayout slug="lockdown-in-san-francisco" heroImage={heroImage} heroCaption={heroCaption}>
        ...
        <p>I had an open and hopeful conversation yesterday with Cat. The last few days I’ve been preparing taxes for myself and Plot Twisters, and I was shaken by how much we had been through in the last year. In my reflection, many emotions flooded my nights and days, including exhaustion, anger, loneliness, and anxiety. I invested so much of my time as well as some money for mixed results. We’re very close to where we started output-wise, but I guess we know a lot more. I feel more confident in myself and others, and I’m more comfortable now than ever expressing my feelings through words. Plus, I made friends and met so many interesting humans, even during a pandemic. I’m in awe of the adventure so far.</p>
