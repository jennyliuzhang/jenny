  ...
  return (
    <main className={entryStyles.entryStyles}>
      <div className={entryStyles.writingTop}>
        <h2><span className="subnav"><Link href="/journal" className="breadcrumb">Jenny&rsquo;s Journal</Link>Lockdown in San Francisco</span></h2>
      </div>
      ...
      <div className={entryStyles.body}>
        <h1>Lockdown in San Francisco</h1>
        <h6>April 2021</h6>
        <h6>4 min read</h6>
