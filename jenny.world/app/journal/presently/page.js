  ...
  return (
    <main className={entryStyles.entryStyles}>
      <div className={entryStyles.writingTop}>
        <h2><span className="subnav"><Link href="/journal" className="breadcrumb">Jenny&rsquo;s Journal</Link>Presently</span></h2>
      </div>
      ...
      <div className={entryStyles.body}>
        ...
        <ol>
          ...
          <Image
            className=""
            src="/journal-graphics/presently/upstart.jpg"
            alt="Project"
            width={1024}
            height={768}
            style={{ width: '100%', height: 'auto' }}
          ...
          <Image
            className=""
            src="/journal-graphics/presently/plot-twisters.png"
            alt="Project"
            width={2505}
            height={880}
            style={{ width: '100%', height: 'auto' }}
          ...
          <Image
            className=""
            src="/journal-graphics/presently/dutch.png"
            alt="Project"
            width={1024}
            height={657}
            style={{ width: '100%', height: 'auto' }}
          ...
          <Image
            className=""
            src="/journal-graphics/presently/new-york.png"
            alt="Project"
            width={1024}
            height={479}
            style={{ width: '100%', height: 'auto' }}
          ...
          <Image
            className=""
            src="/journal-graphics/presently/workshop.jpg"
            alt="Project"
            width={1024}
            height={601}
            style={{ width: '100%', height: 'auto' }}
          ...
          <li>The other day I was stuck while writing a short response metaphor about overcoming adversity for an application, so I took an hour to draw my heart. My final piece is the cover of this blog post. But the blue version below is the original, my honest inner feeling. But I changed the color to make it happier. And then I realized I do this to all my work. And then I realized that this is the metaphor. I overcome adversity by changing its color, becoming a little dishonest at first, but happier. How can I explain this in 1000 characters?</li>

          <Image
            className=""
            src="/journal-graphics/presently/blue.jpg"
            alt="Project"
            width={2204}
            height={1075}
            style={{ width: '100%', height: 'auto' }}
          ...
          <Image
            className=""
            src="/journal-graphics/presently/together.png"
            alt="Project"
            width={1024}
            height={299}
            style={{ width: '100%', height: 'auto', marginTop: '0.5em' }}
            quality={100} 
            priority
          />
          ...
          <li>And though most days I’m a bit tired, I’m quite content to keep going. Life can be really fun. &nbsp;&#x273d;</li>
