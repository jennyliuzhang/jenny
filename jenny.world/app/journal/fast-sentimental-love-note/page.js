...
export default function JournalEntryPage() {
  ...
  const heroCaption = "Gently muddied shoes from a walk on Dean Bridge.";

  return (
    <EntryLayout slug="fast-sentimental-love-note" heroImage={heroImage} heroCaption={heroCaption}>
