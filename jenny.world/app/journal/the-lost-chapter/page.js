  ...
  return (
    <main className={entryStyles.entryStyles}>
      <div className={entryStyles.writingTop}>
        <h2><Link href="/journal" className="breadcrumb">Jenny&rsquo;s Journal</Link>The Lost Chapter</h2>
      </div>
      ...
      <div className={entryStyles.body}>
        ...
        <p>It occurs to me often that I am most definitely not an old soul. I like being friends with people who are or believe they are old souls, but I've concluded that I am a total baby soul. Like, still finding my footing, not tall enough to ride most rides, naive and gawky and terribly foolish soul. I will die this life with a slightly more mature soul God willing, but man, this is not going to be my last rodeo. I may get to presence and love and compassion and non-attachment in this lifetime, but I have too many lessons still before those capstones of total unity with the universe and transcendent surrender. I feel this about myself deeply.</p>

        <p>Something tough about never doing first drafts is that when I go too far down a certain creative direction, like defending a certain argument in a paper or committing to a specific aesthetic or vision for a design project, I tend to fall into the sunk cost fallacy, or I get so close to running out of time entirely so I need to make the best of the work I've already produced. Not enough premeditation. In this way, I'm living my life out here like a final draft too. I have to figure out how to incorporate all the themes here into the final body of work. &nbsp;&#x273d;</p>
