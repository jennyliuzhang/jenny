...
export default function Page() {
  ...
  useEffect(() => {
    fetch('/data/journal.json')
      ...
      .then((data) => {
        const currentIndex = data.findIndex(item => item.writingSlug === "the-great-weird");
  ...
  return (
    <main className={entryStyles.entryStyles}>
      ...
      <div className={entryStyles.heroCaption}>
        Sweet Lila introspecting over a pond in Garfield Park.
      </div>
      ...
      <div className={entryStyles.body}>
        ...
        <p>As I float around, I notice the contrast between my temporary detached attitude and my actual, real self, who is a very high-commitment, values-driven, forthright, enmeshment-friendly personality. I accept this about myself, and actually, I love it. Yes, I will work on the same project for 5 years. Yes, I will sign up for a 3-year Masters degree program. Yes, I will get the unplanned tattoo. Yes, I will be forward about asking new people I like for their numbers—and I will text them. Yes, I will put in the hours to becoming the best I can be at my hobbies. Yes, I will hold my friends accountable. Yes, I will pay $600 upfront to join a members club for a year. And buying a house is the ultimate enmeshment, and I did that in a city I’d never visited, for a house I only saw through an agent on FaceTime. I have no solid answer for why I’m the way I am. Why not?</p>
        ...
        <p>I guess if I were to reflect on why I am such a high-commitment person, I would say something about how I’m aware that my life on Earth is impermanent. Nothing stays put forever, and nothing is perpetually ownable. Yet there must be a reason why my life continues to give me opportunities to try. It introduces me to people that I can choose to grow close with people while knowing that it’s not always going to be perfect, and there’s no guarantee they’ll be in my life forever. It enables me to make homes out of places even though I might be uprooted or, at best, they will go back to nature in due time. It’s only through these commitments I get a peek at just how seriously ephemeral life is. So, the process of striving for permanence in the face of this is a paradoxical yet rewarding journey. It’s disciplinary in that it requires me to define and pursue a goal that is challenging and vulnerable; it invokes positive thinking because once I’m locked into something, I have to make the best of it; and it’s often a social process of discovering my merits, talents, and values in the context of other people. I like to think I was given 80 years alive on Earth to practice the art of letting go, and the most time-effective way to do this is by jumping into projects, people, and places totally and fully and over and over again, immersing my body, wealth, and identity full send into these pursuits, and growing my love and appreciation for all of it until I’m so stuffed with memories of hard work, discovery, failure, and gratitude that I can move on without a fuss and release it all back to where it came from. I commit to things because I want to enrich myself in their experiences <em>so that</em> I can let them go. Does this make any sense?</p>
