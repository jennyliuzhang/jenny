...
export default function ProjectPage() {
  ...
  const heroImage = "/projects/dorsia/dorsia-instagram/cover.jpg";
  ...
  return (
    <ProjectLayout slug="dorsia-instagram" heroImage={heroImage} projectExplain={projectExplain} introPara={introPara} projectDetails={projectDetails}>
