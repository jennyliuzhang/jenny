...
export default function ProjectPage() {
  ...
  const heroImage = "/projects/dorsia/dorsia-illustrations/cover.jpg";
  ...
  return (
    <ProjectLayout slug="dorsia-illustrations" heroImage={heroImage} projectExplain={projectExplain} introPara={introPara} projectDetails={projectDetails}>
