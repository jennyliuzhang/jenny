...
export default function ProjectPage() {
  ...
  const heroImage = "/projects/dorsia/split-pay/cover.jpg";
  ...
  return (
    <ProjectLayout slug="split-pay" heroImage={heroImage} projectExplain={projectExplain} introPara={introPara} projectDetails={projectDetails}>
