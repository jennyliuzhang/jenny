...
export default function ProjectPage() {
  ...
  const heroImage = "/projects/aj-contrast/cover.jpg";
  ...
  return (
    <ProjectLayout slug="aj-contrast" heroImage={heroImage} projectExplain={projectExplain} introPara={introPara} projectDetails={projectDetails}>
