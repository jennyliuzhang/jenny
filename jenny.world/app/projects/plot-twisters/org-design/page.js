...
export default function ProjectPage() {
  ...
  const heroImage = "/projects/plot-twisters/org-design/cover.jpg";
  ...
  return (
    <ProjectLayout slug="org-design" heroImage={heroImage} projectExplain={projectExplain} introPara={introPara} projectDetails={projectDetails}>
