...
export default function ProjectPage() {
  ...
  const heroImage = "/projects/plot-twisters/plottwisters-org/cover.gif";
  ...
  return (
    <ProjectLayout slug="plottwisters-org" heroImage={heroImage} projectExplain={projectExplain} introPara={introPara} projectDetails={projectDetails}>
