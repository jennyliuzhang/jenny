...
export default function ProjectPage() {
  ...
  const heroImage = "/projects/plot-twisters/early-research/cover.jpg";
  ...
  return (
    <ProjectLayout slug="early-research" heroImage={heroImage} projectExplain={projectExplain} introPara={introPara} projectDetails={projectDetails}>
