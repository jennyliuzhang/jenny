...
export default function ProjectPage() {
  ...
  const heroImage = "/projects/plot-twisters/think-tank/cover.jpg";
  ...
  return (
    <ProjectLayout slug="think-tank" heroImage={heroImage} projectExplain={projectExplain} introPara={introPara} projectDetails={projectDetails}>
