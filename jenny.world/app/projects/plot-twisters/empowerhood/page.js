...
export default function ProjectPage() {
  ...
  const heroImage = "/projects/plot-twisters/empowerhood/cover.jpg";
  ...
  return (
    <ProjectLayout slug="empowerhood" heroImage={heroImage} projectExplain={projectExplain} introPara={introPara} projectDetails={projectDetails}>
