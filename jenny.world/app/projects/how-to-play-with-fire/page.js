...
export default function ProjectPage() {
  ...
  const heroImage = "/projects/how-to-play-with-fire/cover.jpg";
  ...
  return (
    <ProjectLayout slug="how-to-play-with-fire" heroImage={heroImage} projectExplain={projectExplain} introPara={introPara} projectDetails={projectDetails}>
